...
public class UserServiceImpl implements UserService {
    ...
    private static final String SignupUserQuery = "INSERT INTO " + UsersDBConstants.TABLE_USERS
            + "  VALUES(?,?,?,?,?,?,?,?)";
    ...
    public String Signup(UserRole role, User user) throws StoreException {
        ...
        Connection con = DBUtil.getConnection();
        try {
            PreparedStatement ps = con.prepareStatement(SignupUserQuery);
            ...
            if (responseMessage.contains("Duplicate"))
                responseMessage = "User already Signuped with this email !!";
            e.printStackTrace();
        }
